...
discVelocity= [5,5]
img = pygame.image.load('ex05/fig/disc.png')
#background = pygame.image.load('./background.jpg')
bluepadimg = pygame.image.load('ex05/fig/bluepad.png')
redpadimg = pygame.image.load('ex05/fig/redpad.png')
...
if bp_rct.colliderect(pk_rct) and flag:
            vx *= -1
            vy *= -1
            flag=False